# twitterssearchscraper THIS GUIDE IS OUTDATED (Simply specify search terms and directories in the code and run twitterscraper.py [ensure chromedriver.exe is present])
